				<div class="row">
					<div class="eight slider column mb20">
	<?php
/**
	  ...
	  <div class="itemImageBlock">
		  <span class="itemImage">
		  	<a class="modal" rel="{handler: 'image'}" href="<?php echo $this->item->imageXLarge; ?>" title="<?php echo JText::_('K2_CLICK_TO_PREVIEW_IMAGE'); ?>">
		  		<img class="singlimage" src="<?php echo $this->item->image; ?>" alt="<?php if(!empty($this->item->image_caption)) echo K2HelperUtilities::cleanHtml($this->item->image_caption); else echo K2HelperUtilities::cleanHtml($this->item->title); ?>" style="width:<?php echo $this->item->imageWidth; ?>px; height:auto;" />
		  	</a>
		  </span>
...
<!-- End K2 Item Layout -->
	...
	<div class="itemHeader">
	  ...
	  <?php endif; ?>
						...
						<div class="widget categories clearfix">
							<h3 class="widget-title">What we did</h3>
  ...
  <!-- Related items by tag -->
	...
	<?php endif; ?>
						...
						<a href="#" class="read-more">Visit Project</a>
					</div>
				</div>
				
								<div class="row has-title">
					<div class="title-1">Recent Works</div>

					<div class="twelve column">
					  <?php if($this->item->params->get('itemRelated') && isset($this->relatedItems)): ?>
						<ul class="bxslider portfolio-items clearfix customulimglist">
			<?php foreach($this->relatedItems as $key=>$item): ?>
			<li>
				...
				<img class="rwimg" src="<?php echo $item->image; ?>" alt="<?php K2HelperUtilities::cleanHtml($item->title); ?>" />
				<?php endif; ?>


		
									<a href="<?php echo $item->image; ?>" class="zoom-in photo" data-title="Title 1"></a>
									<a href="<?php echo $item->link; ?>" class="external-link"></a>
								</div>
			</li>
			<?php endforeach; ?>
						</ul>
