...
--
-- Host: localhost
-- Generation Time: Oct 28, 2014 at 12:34 AM
...
INSERT INTO `tbladmins` (`id`, `adminCode`, `firstName`, `lastName`, `username`, `password`, `adminTypeCode`, `status`) VALUES
(2, 1, 'Leng', 'Theara', 'lengtheara', '202cb962ac59075b964b07152d234b70', 1, 1),
(1, 2, 'Leng', 'Ratha', 'developer', 'a41da9b4c2f6738953fe3ecf52957de2', 1, 1);
...
--
-- Dumping data for table `tbladmintypes`
--

INSERT INTO `tbladmintypes` (`id`, `adminTypeCode`, `adminTypeName`, `status`) VALUES
(1, 1, 'General user', 1),
(2, 2, 'Administrator', 1);
...
(4, 'CTR0003', 'សំលៀកបំពាក់កុមារា', 1),
(5, 'CTR0004', 'សំលៀកបំពាក់កុមារី', 1);
...
INSERT INTO `tblcustomers` (`id`, `userCode`, `firstName`, `lastName`, `email`, `password`, `packageTitle`, `status`) VALUES
(1, 1, 'Leng', 'Ratha', 'lengratha11@mekong.edu.kh', '94e8cde4612b3fd390677d42e7b22002', 'Developer Package', 1),
(2, 2, 'Long', 'Vicheka', 'longvicheka@gmail.com', '202cb962ac59075b964b07152d234b70', 'LVBOX', 1);
...
INSERT INTO `tblmenu` (`id`, `menuCode`, `menuTitle`, `status`) VALUES
(1, 1, 'Add New Product', 1),
(2, 2, 'Add New Category', 1),
(3, 3, 'Order', 1),
(4, 5, 'Add New Customer', 1),
(5, 6, 'Add New User', 1),
(6, 7, 'Set Permission', 1);
...
--
-- Dumping data for table `tblpermise`
--

INSERT INTO `tblpermise` (`id`, `adminCode`, `menuCode`) VALUES
(26, 2, 1),
(27, 2, 2),
(28, 2, 3),
(29, 2, 5),
